...
public class BookAResourceTests
{
    ...
    public class BookingTests
    {
        ...
        public void Booking_Creation_LejEnRessource_SetsCorrectProperties()
        {
            ...
            // Act – create booking
            var booking = new Booking(resourceId, personId, startTime, endTime);
        ...
        public void Cannot_Create_Overlapping_Booking()
        {
            ...
            var existingBooking = new Booking(resourceId, personId1, start1, end1);
            ...
            var newBooking = new Booking(resourceId, personId2, start2, end2);
